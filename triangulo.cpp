...
void Triangulo::exibir(float R, float G, float B)
{
...
void Triangulo::escalonarNU(float val)
{
	//A escalonação não uniforme altera o valor X e Y dos dois pontos de baixo do triangulo
	coordenadas[0] *= val;
	coordenadas[1] *= val;
	coordenadas[4] *= val;
	coordenadas[5] *= val;
